...
class Profile(models.Model):
    prouser = models.OneToOneField(User,on_delete=models.CASCADE,null=True,blank=True)
    image = models.ImageField(upload_to='profile/',default='profile/userprofile.png',blank=True,null=True)
